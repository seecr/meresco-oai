...
# Copyright (C) 2014-2016, 2018, 2020-2021 Seecr (Seek You Too B.V.) https://seecr.nl
...
class OaiInfoTest(SeecrTestCase):
    ...
    def setUp(self):
        ...
        self.jazz.updateMetadataFormat(prefix="prefix1", schema="", namespace="")
        self.jazz.updateMetadataFormat(prefix="oai", schema="oai-schema", namespace="oai-namespace")
        self.jazz.addOaiRecord(identifier='record1', setSpecs=['set1'], metadataPrefixes=['prefix1'])
        self.jazz.addOaiRecord(identifier='record2', setSpecs=['set1'], metadataPrefixes=['prefix1', 'oai'])
        self.jazz.addOaiRecord(identifier='record3', setSpecs=['set1', 'set2'], metadataPrefixes=['prefix1'])

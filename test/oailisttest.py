...
from mockoaijazz import MockOaiJazz, MockRecord
...
class OaiListTest(SeecrTestCase):
    def setUp(self):
        ...
        def oaiRecord(record, metadataPrefix):
    ...
    def testListRecords(self):
        self.observer.returnValues['oaiSelect'] = (MockRecord(f) for f in ['id:0&0', 'id:1&1'])
    ...
    def testListRecordsProducesResumptionToken(self):
        ...
        self.observer.returnValues['oaiSelect'] = (MockRecord(f) for f in ['id:0&0', 'id:1&1', 'id:2&2'])
    ...
    def testListRecordsWithResumptionToken(self):
        self.observer.returnValues['oaiSelect'] = (MockRecord(f) for f in ['id:2&2'])
    ...
    def testListRecordsEmptyFinalResumptionToken(self):
        self.observer.returnValues['oaiSelect'] = (MockRecord(f) for f in ['id:2&2', 'id:3&3'])
    ...
    def testListRecordsUsingXWait(self):
        ...
        self.oaiList.addObserver(self.observer)
        self.observer.returnValues['oaiSelect'] = (MockRecord(f) for f in [])
        ...
        self.observer.returnValues['oaiSelect'] = (MockRecord(f) for f in ['id:1&1'])
    ...
    def testFromAndUntil(self):
        def selectArguments(oaiFrom, oaiUntil):
            self.observer.returnValues['oaiSelect'] = (MockRecord(f) for f in ['id:3&3'])
            self.observer.calledMethods.reset()
    ...
    def testXCount(self):
        ...
        self.observer.returnValues['oaiSelect'] = (MockRecord(f) for f in ['id:999&999'])
